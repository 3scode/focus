    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm flex flex-col items-center gap-6 animate-fade-up">
        ...
        <p className="text-sm text-[#8A8F98] text-center">
          Masuk ke akun Time Blocking kamu
        </p>
        <SignInButton mode="modal" fallbackRedirectUrl={`${BASE}/today`}>
        ...
        <p className="text-sm text-[#8A8F98]">
          Belum punya akun?{" "}
          <Link href="/sign-up" className="text-[#5E6AD2] hover:text-[#6872D9] transition-colors">
            Daftar
          </Link>
        </p>
      </div>
