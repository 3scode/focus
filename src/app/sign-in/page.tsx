    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-[#EDEDEF] mb-1">Masuk</h1>
          <p className="text-sm text-[#8A8F98]">Masuk ke akun Focus kamu</p>
        </div>
        ...
        <p className="text-center text-sm text-[#8A8F98] mt-6">
          Belum punya akun?{" "}
          <Link href="/sign-up" className="text-[#5E6AD2] hover:text-[#6872D9] font-medium transition-colors">
            Daftar
          </Link>
        </p>
      </div>
